...
function Sidebar({
	...
	// React.useEffect(() => {
	// 	if (isMobile || state !== "expanded" || collapsible === "none") {
	// 		return;
	// 	}
	...
	// 			target.closest(
	// 				"[data-sidebar='trigger'], [data-sidebar='rail'], [data-radix-popper-content-wrapper]",
	// 			)
	// 		) {
	// 			return;
	// 		}
	...
	// const handleSidebarClickCapture = React.useCallback(
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				"ml-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border pl-2.5 py-0.5 group-data-[collapsible=icon]:hidden border-zinc-400",
				className,
			)}
			{...props}
		/>
